...
The launchable 1.16 source is preserved under **versions/1.16**. Earlier snapshots remain under **versions**. This release uses the existing Python runtime; an executable/installer is not included.

...
class Manuscript(QWidget):
    ...
    def __init__(self, ink_factory, parent=None):
        ...
        self.loading = False
        self.rows = []
        self.setObjectName('manuscriptPaper')
        self.setMaximumWidth(860)
        self.setMinimumWidth(420)
        self.setStyleSheet('QWidget#manuscriptPaper { background: #f2efe8; border: 1px solid #d5d0c6; }')
        ...
        layout.setContentsMargins(48, 38, 48, 44)
        layout.setSpacing(0)
        ...
        self.editor.setStyleSheet('QTextEdit { background: transparent; border: 0; color: #1d1d1b; padding: 0; font-family: Georgia; font-size: 18px; selection-background-color: #b9d8dc; selection-color: #111111; }')

...
# 1.20 — Collections, manuscript, Storyline and Transcape

Unified Collections with a separate footage workspace; moved Library assignment
to its bottom bar; added continuous manuscript editing and linked Storyline
sequences; introduced an active Cut tool and synchronized sequence scrubber;
added Premiere/project export choices and the Transcape logo Easter egg.
52 tests and isolated desktop/narrow UI checks pass. See docs/product/RELEASE-1.20.md.

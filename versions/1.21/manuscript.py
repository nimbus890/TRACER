...
class Manuscript(QWidget):
    ...
    def __init__(self, ink_factory, parent=None):
        ...
        self.status_line = QLabel('Synced to Storyline · 0 passages · 00:00')
        ...
        self.hint = QLabel('Edit normally • delete text or use menu to exclude • right-click to trim or split • Ctrl+Z to undo')
        self.hint.setWordWrap(True)
        self.hint.setStyleSheet('color: #777777; font-size: 11px;')
    ...
    def set_document(self, document):
        ...
        if document:
            ...
            self.status_line.setText('Synced to Storyline · 0 passages · 00:00')
    ...
    def schedule_commit(self):
        if self.loading or self.document is None:
            return
        self.status_line.setText('Syncing…')
    ...
    def update_active_passage_badge(self):
        ...
        if passage:
            ...
            self.passage_badge.setText(f"[{start:.2f}s – {end:.2f}s · {dur:.1f}s · {quality}]{spk_str}")

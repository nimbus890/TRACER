...
timing details are contextual. Storyline media uses a searchable single-column
bin and compact Add/Insert actions. Timeline tools occupy two legible rows.
...
are recorded in RELEASE-1.20.md and VALIDATION.md.

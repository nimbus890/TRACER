...
source timing behind text, and updates one linked Storyline sequence. Manual
timeline edits survive subsequent manuscript changes as a preserved cut.
Select/Cut are explicit timeline tools. Export offers Premiere-compatible XML
or a collected project folder. Double-clicking the logo opens Transcape; Escape
returns. See RELEASE-1.20.md for boundaries and recovery behavior.

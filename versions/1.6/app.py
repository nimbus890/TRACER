...
QPushButton#processStart { background: #b8d9c3; color: #102018; border: 0; padding: 8px 18px; border-radius: 4px; font-weight: 750; }
...
QPushButton#advancedToggle { background: #1b1b1a; border-color: #393733; padding: 6px 10px; }
...
def tile_icon(kind):
    ...
    if kind == 'audio':
        ...
        painter.drawEllipse(9, 5, 21, 21)
        painter.drawLine(27, 23, 37, 31)
        painter.drawLine(19, 10, 19, 20)
        painter.drawLine(14, 15, 24, 15)
    elif kind == 'interval':
...
class ChoiceTile(QToolButton):
    ...
    def __init__(self, icon_kind, title, caption='', compact=False, icon_only=False, parent=None):
        ...
        self.setIconSize(QSize(25, 21) if compact else QSize(21, 18) if icon_only else QSize(44, 34))
    ...
    def _apply_style(self):
        ...
        palettes = {
            'audio': ((78, 52, 98), (203, 179, 229)),
            'frame': ((36, 82, 101), (155, 204, 224)),
            'ai': ((38, 88, 57), (174, 218, 190)),
        }
        ...
        border = '#%02x%02x%02x' % tuple(mix(a, b) for a, b in zip((48, 47, 44), selected_border))
...
class OptionsDialog(QDialog):
    def __init__(self, options, folders, parent, batch_name='folder batch'):
        ...
        header = QHBoxLayout()
        header.addWidget(label('Process ' + batch_name, 'title'))
        header.addStretch()
        self.advanced_toggle = button('Advanced settings', self.toggle_advanced)
        self.advanced_toggle.setObjectName('advancedToggle')
        self.advanced_toggle.setCheckable(True)
        self.advanced_toggle.setToolTip('Model, processing device, and screenshot size')
        ...
        main_form.addRow(self.screenshot_mode_title, mode_box)
        ...
        main_form.addRow(self.format_title, format_box)
        ...
        main_form.addRow(self.output_title, location_box)
    ...
    def toggle_advanced(self, checked):
        ...
        self.advanced_toggle.setText('Close advanced' if checked else 'Advanced settings')
...
class Window(QMainWindow):
    def __init__(self):
        ...
        side.addSpacing(15)
        side.addWidget(label('TransPro · 1.6', 'subtle'))
    ...
    def refresh_models(self):
        ...
        if hasattr(self, 'visual_model_state'):
            ...
            self.visual_model_state.setText(('Installed · ' if ready else 'Included with 1.6 · approximately ') + size_text(size))

...
The editable 1.7 source is preserved under **versions/1.7**. Its installer is intentionally deferred until an exportable build is requested; completed earlier installers remain in **release**.

...
class OptionsDialog(QDialog):
    def __init__(self, options, folders, parent, batch_name='folder batch'):
        ...
        self.resize(820, 660)
        self.closed_width = 820
        self.advanced_width = 1140
...
class Window(QMainWindow):
    def __init__(self):
        ...
        side.addSpacing(15)
        side.addWidget(label('TransPro · 1.7', 'subtle'))
    ...
    def refresh_models(self):
        ...
        if hasattr(self, 'visual_model_state'):
            ...
            self.visual_model_state.setText(('Installed · ' if ready else 'Included with 1.7 · approximately ') + size_text(size))

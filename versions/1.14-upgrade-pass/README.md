...
Double-click **Launch Tracer 1.14 Upgrade Pass.vbs** in this folder to open this preserved source snapshot. A future export build will be created as **dist/Tracer/Tracer.exe**.
...
The original editable 1.14 source is preserved under **versions/1.14** and its post-milestone Upgrade Pass under **versions/1.14-upgrade-pass**, with earlier snapshots still available under **versions**. The 1.14 installer is intentionally deferred until an exportable build is requested; completed earlier TransPro installers remain in **release**.

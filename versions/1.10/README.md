...
The editable 1.10 source is preserved under **versions/1.10**. Its installer is intentionally deferred until an exportable build is requested; completed earlier TransPro installers remain in **release**.
...
## Unified offline search in 1.10

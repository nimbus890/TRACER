...
class ChoiceTile(QToolButton):
    ...
    def _apply_style(self):
        ...
        palettes = {
            'audio': ((56, 192, 248), (0, 0, 0)),
            'frame': ((248, 200, 64), (0, 0, 0)),
            'ai': ((0, 208, 80), (0, 0, 0)),
        }
...
class Window(QMainWindow):
    def __init__(self):
        ...
        side.addSpacing(15)
        side.addWidget(label('Tracer · 1.10', 'subtle'))
    ...
    def refresh_models(self):
        ...
        if hasattr(self, 'visual_model_state'):
            ...
            self.visual_model_state.setText(('Installed · ' if ready else 'Included with 1.10 · approximately ') + size_text(size))

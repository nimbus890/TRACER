...
class WorkspaceTests(unittest.TestCase):
    ...
    def test_paper_search_browses_multiple_sources_without_covering_script(self):
        ...
        self.assertTrue(page.paper.rows[0].text.extraSelections())
        page.paper.rows[0].text.setPlainText('An archer remembers home.')
        ...
        page.search_results.setCurrentRow(0)
        self.qt.processEvents()
        self.assertEqual(page.paper.rows[0].text.toPlainText(), 'An archer remembers home.')
